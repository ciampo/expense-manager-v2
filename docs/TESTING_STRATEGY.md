...
Coverage is evaluated **across all three layers combined**, not by unit
test coverage alone. A file at "0% unit coverage" may be thoroughly
tested by E2E and visual regression tests.
